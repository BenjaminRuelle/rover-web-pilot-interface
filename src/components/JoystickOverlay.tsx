  ...
  return (
    ...
    >
      ...
      <div className={`relative transition-all duration-300 ${
        ...
        <div className={`absolute inset-0 bg-black/60 backdrop-blur-md rounded-xl border border-white/30 transition-all duration-300 ${
          isHovered ? 'opacity-100 scale-110 p-8' : 'opacity-40 scale-100 p-4'
        }`}>
